...
public class LastMessage: NSObject, Mappable {


    internal let kUsercreate_dateKey:               String = "create_date"
    internal let kSenderUserKey:                    String = "sender"
    ...
    public init(json: JSON) {
        ...
        sender = SenderUser(json: json[kSenderUserKey])
    ...
    public func dictionaryRepresentation() -> [String : AnyObject ] {
        ...
        if sender != nil {
            dictionary.updateValue(sender!.dictionaryRepresentation() as AnyObject, forKey: kSenderUserKey)
        }
